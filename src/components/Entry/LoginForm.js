...
const useStyles = makeStyles((theme) => ({
  mainCont: {
    ...
    backgroundImage:
      "url(https://images.unsplash.com/photo-1498579809087-ef1e558fd1da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80)",
      ...
      <form className={classes.form} onSubmit={loginForm}>
        <Paper className={classes.paper}>
          ...
          <TextField
            ...
            onChange={handleChanges}
          />
          <Typography className={classes.specialFont}>
